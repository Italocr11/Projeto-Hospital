DROP DATABASE IF EXISTS hospital_prime;

CREATE DATABASE hospital_prime;
...
CREATE TABLE Quarto (
    ...
    Id_setor_FK BIGINT UNSIGNED NOT NULL,
...
CREATE TABLE Leito (
    ...
    Id_quarto_FK BIGINT UNSIGNED NOT NULL,
...
CREATE TABLE Recepcionista (
    Id_funcionario BIGINT UNSIGNED PRIMARY KEY,
    telefone       VARCHAR(20),
...
CREATE TABLE Enfermeiro (
    ...
    turno          VARCHAR(20) NOT NULL,
    Id_gerencia_FK BIGINT UNSIGNED,
...
CREATE TABLE Medicamento_alergia (
    Id_medicamento_FK BIGINT UNSIGNED NOT NULL,
    Id_alergia_FK     BIGINT UNSIGNED NOT NULL,
...
CREATE TABLE Agendamento (
    ...
    Id_funcionario_FK BIGINT UNSIGNED NOT NULL,
...
CREATE TABLE Triagem (
    ...
    Id_paciente_FK BIGINT UNSIGNED NOT NULL,
...
CREATE TABLE Consulta (
    ...
    horario            TIME NOT NULL,
    data               DATE NOT NULL,
    Id_triagem_FK      BIGINT UNSIGNED NOT NULL,
    Id_funcionario_FK  BIGINT UNSIGNED NOT NULL,
    Id_agendamento_FK  BIGINT UNSIGNED NOT NULL UNIQUE, 
...
CREATE TABLE Internacao (
    ...
    Id_paciente_FK BIGINT UNSIGNED NOT NULL,
    Id_leito_FK    BIGINT UNSIGNED NOT NULL,
...
CREATE TABLE Internacao_medico (
    Id_internacao_FK  BIGINT UNSIGNED NOT NULL,
    Id_funcionario_FK BIGINT UNSIGNED NOT NULL,
...
CREATE TABLE Exame (
    ...
    status         VARCHAR(30)  NOT NULL,
    dados          TEXT,
    Id_consulta_FK BIGINT UNSIGNED NOT NULL,
...
CREATE TABLE Resultado_exame (
    ...
    Id_exame_FK    BIGINT UNSIGNED  NOT NULL UNIQUE,
...
CREATE TABLE Item_Prescricao (
    ...
    Id_prescricao_FK  BIGINT UNSIGNED NOT NULL,
    Id_medicamento_FK BIGINT UNSIGNED NOT NULL,
...
CREATE TABLE Convenio_paciente (
    Id_convenio_FK BIGINT UNSIGNED NOT NULL,
    Id_paciente_FK BIGINT UNSIGNED NOT NULL,
...
CREATE TABLE Paciente_responsavel (
    Id_responsavel_FK BIGINT UNSIGNED NOT NULL,
    Id_paciente_FK    BIGINT UNSIGNED NOT NULL,
...
CREATE TABLE Plantao_medico (
    Id_funcionario_FK    BIGINT UNSIGNED NOT NULL,
    Id_plantao_medico_FK BIGINT UNSIGNED NOT NULL,
...
CREATE TABLE Plantao_enfermeiro (
    Id_funcionario_FK        BIGINT UNSIGNED NOT NULL,
    Id_plantao_enfermeiro_FK BIGINT UNSIGNED NOT NULL,
...
CREATE TABLE Setor_plantao (
    Id_setor_FK   BIGINT UNSIGNED NOT NULL,
    Id_plantao_FK BIGINT UNSIGNED NOT NULL,
